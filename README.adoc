...
* The data of _wallbox_location_chargestatus_ is processed by Grafana with the help of PostgreSQL and then displayed on a worldmap panel in Grafana. This can be inspected from http://localhost:3000/ in the panel called "location_chargestatus".
