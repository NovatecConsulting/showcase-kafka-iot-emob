...
public class ProtocolTranslationTest{ 
    ...
    public void protocolTranslation(){
        ...
        String charge = translator.protocol_translation(null,null,null,null,null,null,null,null,null);
        assertEquals(charge,"ready");
        charge = translator.protocol_translation("ready",null,null,null,null,null,null,null,null);
        assertEquals(charge,"ready");
